                  ...
                  <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content" style="width: 100%">
                      <div class="tab-pane active" id="tab_1-1"><BR><BR>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CEDULA del ciudadano remitente:</label>
                        <br>
                        <div class="col-md-12"> 
                          <div class=" input-group">
                            <input type="text" class="form-control" placeholder="Ingresar Cedula del ciudadano remitente a buscar" id="txtbuscar_dniremitente" onkeypress="return soloNumeros(event)">
