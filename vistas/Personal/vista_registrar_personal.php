    ...
    <div class="panel-body">     
          <div class="col-md-12 col-lg-12 col-xs-12"> 
            ...
            <div class="col-sm-4">
                ...
                <input type="text" class="form-control" id="txtdni" onkeypress="return soloNumeros(event)"   maxlength="13" style="background-color: #FFFFFF" placeholder="Ingrese Nº Documento Identidad">
                <br>
            </div>
            <div class="col-sm-4">
                <label >Sexo</label>
