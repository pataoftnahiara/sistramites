...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="icon-trash fa-fw"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="icon-cloud-upload text-success"></i> ',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="icon-eye icons"></i>',
        ...
        dragSettings: {},
        indicatorNew: '<i class="icon-point-down text-warning"></i> ',
        indicatorSuccess: '<i class="icon-cloud-check text-success"></i> ',
        indicatorError: '<i class="icon-notification2 text-danger"></i> ',
        indicatorLoading: '<i class="icon-point-up text-muted"></i> ',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '',
            next: '',
            toggleheader: '<i class="icon-size-fullscreen-blanco"></i>',
            fullscreen: '<i class="icon-size-fullscreen"></i>',
            borderless: '<i class="icon-size-fullscreen-blanco"></i>',
        ...
        previewFileIcon: '<i class="icon-file-empty2"></i> ',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="icon-doc"></i> ',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="icon-trash"></i>',
        removeClass: 'btn btn-danger',
        cancelIcon: '<i class="icon-cross2"></i> ',
        ...
        msgValidationErrorIcon: '<i class="icon-notification2"></i> ',
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'Retirar',
        removeTitle: 'Borrar Archivo Seleccionado',
        cancelLabel: 'Cancel',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Upload',
        uploadTitle: 'Cargar Archivo seleccionado',
        msgNo: 'No',
