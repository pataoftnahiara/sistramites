...
<body>
  ...
  <div class="app app-header-fixed" id="app" action="index.php">
    <div class="app-header navbar">
      <div class="navbar-header bg-dark">
        ...
        <a href="admin.php" class="navbar-brand text-lt">
          ...
          <span class="hidden-folded m-l-xs">MENU | SGT</span>
        </a>
      </div>
        ...
        <div class="navi-wrap">
          ...
          <nav ui-nav class="navi">
            ...
            ?>
             ...
             <!--  <li class="line dk">  FALTA PROCESO DE ESTA PARTE DE REPORTES
              <li ui-sref-active="active">
        ...
        <div class="contendor_kn">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <img style="text-align: center;" align="center" src="logo_1.png">
            </div>
            </div>  
          </div>
        </div>
    ...
    <div class="app-footer wrapper b-t bg-light">
      ...
      &copy; 2021 Copyright | Jose Cobo | Patricio Taipe | Nahim Castro.
    </div>
    <!-- / footer -->
  </div>
  <!-- jQuery -->
              ...
              <div class="panel-body">
                <form method="POST" id="update-form-administrador">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-sm-4">
                      <input type="text"  class="form-control"  onkeypress="return soloNumeros(event)" name="dni_personal" id="dni_personal" placeholder="Ingrese CEDULA" maxlength="13">
                      <br>
                    </div> 
                  </div>
